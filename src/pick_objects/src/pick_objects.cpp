...
float pickUpGoal[3] = { 2.0, 0.0, 1.0};
float dropOffGoal[3] = { 7.0, -2.0, 1.0};
...
int main(int argc, char** argv)
{
	...
	if(!pick)
	{
		...
		goal.target_pose.pose.position.x = pickUpGoal[0]; 
		goal.target_pose.pose.position.y = pickUpGoal[1]; 
